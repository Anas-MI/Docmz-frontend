...
import {
    Breadcrumb, Layout, Menu, Typography, Form,
    Input,
    Tooltip,
    Cascader,
    Checkbox,
...
class Newsearch extends Component {
    ...
    carrierChange = (carrier) => {
        ...
        // for(let i=0;i<carriers.carriers.length;++i)
        // {
        //     console.log(carriers.carriers[i].name);
        // }
...
export default Form.create()(Newsearch)
